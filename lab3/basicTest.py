...
class Main(object):
    ...
    def parse_options(self):
        ...
        self.remaining_args = [int(arg) for arg in args]
    ...
    def run(self):
        ...
        # setup network
        net = Network('../networks/lab3/network.txt')
        net.loss(self.loss)
        ...
        # setup connection
        c1 = TCP(t1, n1.get_address('n2'), 1, n2.get_address('n1'), 1, a, window=self.window, fastRetransmit=self.fast_retransmit, drop=self.remaining_args)
